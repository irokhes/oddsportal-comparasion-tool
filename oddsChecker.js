...
const lineWithOverUnderBet = (bet, lines) => {
  ...
  lines.some((line) => {
    ...
    if (bet.betTo === 'local' && bet.odds === bet.lastOddBet365) console.log(`la linea no se ha movido ${bet.odds}, orignal avg odds ${bet.avgOdds}, actuales ${line.overOdds} \n ${bet.url}`);
    ...
    if (bet.betTo === 'away' && bet.odds === bet.lastOddBet365) console.log(`la linea no se ha movido ${bet.odds}, orignal avg odds ${bet.avgOdds}, actuales ${line.underOdds} \n ${bet.url}`);
