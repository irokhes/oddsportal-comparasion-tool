...
const composeDriftedBet = (driftedBet) => `Diferencia entre lineas AH ${driftedBet.lineValue} ${driftedBet.ahOdds} - ${driftedBet.dnbOdds ? driftedBet.dnbOdds : driftedBet.dcOdds} - ${driftedBet.linesDifference}%\n\n<a href="${driftedBet.url}" target="_blank">${driftedBet.match}</a>\n\n`;
